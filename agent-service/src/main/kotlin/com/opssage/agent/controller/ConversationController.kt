...
import com.opssage.agent.dto.ReplyRequest
...
class ConversationController(
    ...
    @GetMapping
    fun findAll(): List<Conversation> = conversationRepository.findAll()
    ...
    ): InvestigationReport = investigationService.reply(id, request.toInput())
}
