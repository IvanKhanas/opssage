...
class InvestigationCommandOutbox(
            ...
            OutboxMessage(
                destination =
                    OutboxDestination(
                        ...
                        key = command.metadata.requestId,
                    ),
    ...
    private companion object {
        const val INVESTIGATION_REQUESTED = "InvestigationRequested"
    }
}
