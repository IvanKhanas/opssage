...
@Repository
class MongoRunbookRepository(
    private val repository: RunbookMongoRepository,
) : RunbookRepository {

    override fun findById(id: String): Mono<Runbook> = repository.findById(id)

    override fun findAll(): Flux<Runbook> = repository.findAll()

    override fun findByServiceId(serviceId: String): Flux<Runbook> =
